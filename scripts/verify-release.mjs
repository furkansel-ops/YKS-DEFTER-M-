...
if(localVersion.version!=="4.4.0"||localVersion.build!=="4.4.0-r4"||localVersion.schema!==21)throw new Error(`Beklenmeyen v4.4.0 kimliği: ${JSON.stringify(localVersion)}`);
