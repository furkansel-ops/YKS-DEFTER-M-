...
if(pkg.version!=="4.3.0")throw new Error(`Beklenmeyen paket sürümü: ${pkg.version}`);
...
const checks={
  version:bundle.includes("4.3.0")&&version.version==="4.3.0"&&version.build==="4.3.0-r1",
  ...
  pwa:sw.includes('const APP_VERSION="4.3.0"')&&sw.includes('const APP_BUILD="4.3.0-r1"')&&sw.includes('const CACHE="yks-core-v4.3.0-r1"')
};
