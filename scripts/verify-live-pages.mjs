...
export function verifyPolicyPages({privacy,deletion}){
  if(!privacy.includes("YKS Defterim Gizlilik Politikası")||!privacy.includes("IndexedDB/Dexie")||!privacy.includes("Google Cloud Firestore")||!privacy.includes("Android, Windows ve web")||!privacy.includes("Firebase Authentication")||!privacy.includes("E-posta adresi doğrulanmadan çalışma verileri eşitlenmez")||/<script\b/i.test(privacy))throw new Error("Canlı gizlilik politikası eksik veya yayın sözleşmesiyle uyumsuz");
