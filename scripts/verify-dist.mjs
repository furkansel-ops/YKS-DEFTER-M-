...
const required=[
  ...
  "modules/learning-lab.js","modules/learning-lab-v2.js","modules/target-center.js","modules/export-center.js",
...
const [bundle,app,sw,versionText,recovery,stability,personal,progress,labV2]=await Promise.all([
...
for(const asset of ["error-journal.js?v=4.1.0-r20","personal-upgrades.js?v=4.1.0-r20","progress-v2.js?v=4.1.0-r20","learning-lab-v2.js?v=4.1.0-r20"])if(!sw.includes(asset))throw new Error("Kişisel modül çevrimdışı çekirdekte eksik: "+asset);
if(!stability.includes("personal-upgrades.js?v=4.1.0-r20")||!stability.includes("progress-v2.js?v=4.1.0-r20")||!stability.includes("learning-lab-v2.js?v=4.1.0-r20"))throw new Error("Kişisel geliştirme modülleri çalışma zamanında yüklenmiyor");
