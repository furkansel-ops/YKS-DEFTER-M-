...
if(!sw.includes('const APP_VERSION="4.1.0"')||!sw.includes('const APP_BUILD="4.1.0-r20"')||!sw.includes('const CACHE="yks-core-v4.1.0-r23"'))throw new Error("Kopyalanan service worker kararlı sürüm/cache revizyonuyla eşleşmiyor");
for(const asset of ["error-journal.js?v=4.1.0-r20","personal-upgrades.js?v=4.1.0-r20","progress-v2.js?v=4.1.0-r20","learning-lab-v2.js?v=4.1.0-r20","learning-lab-v3.js?v=4.1.0-r23"])if(!sw.includes(asset))throw new Error("Kişisel modül çevrimdışı çekirdekte eksik: "+asset);
if(!stability.includes("personal-upgrades.js?v=4.1.0-r20")||!stability.includes("progress-v2.js?v=4.1.0-r20")||!stability.includes("learning-lab-v2.js?v=4.1.0-r20")||!stability.includes("learning-lab-v3.js?v=4.1.0-r23"))throw new Error("Kişisel geliştirme modülleri çalışma zamanında yüklenmiyor");
