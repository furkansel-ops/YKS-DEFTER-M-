...
if(!index.includes('./app.js?v=4.0.0-r16')||!index.includes('./modules/learning-lab.js?v=4.0.0-r16'))throw new Error("Uygulama çalışma zamanı üretim paketinde bağlı değil");
