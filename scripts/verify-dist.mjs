...
if(!index.includes('./app.js?v=4.0.0-r15')||!index.includes('./modules/learning-lab.js?v=4.0.0-r15'))throw new Error("Uygulama çalışma zamanı üretim paketinde bağlı değil");
