...
if(!sw.includes('motivation-quotes-v1.js?v=4.1.0-r4')||!sw.includes('motivation-quotes-v2.css?v=4.1.0-r2')||!stability.includes('motivation-quotes-v1.js?v=4.1.0-r4'))throw new Error("Günün sözü çalışma zamanı/PWA çekirdeğine bağlı değil");
if(motivation.includes('const EXAM_QUOTES=')||!motivation.includes('const COACH_QUOTES=')||!motivation.includes('const PLAYER_QUOTES=')||!motivation.includes('scope:"football-only"')||!motivation.includes('style:"v2"')||!motivation.includes('Teknik Direktör')||!motivation.includes('Futbolcu')||!motivation.includes('yeniSoz=function'))throw new Error("Futbolcu + teknik direktör söz havuzu eksik veya paketlenmedi");
...
const atlasChunk=chunks.find(name=>/^biology-atlas-(?!model-|diagrams-).+\.js$/.test(name));
