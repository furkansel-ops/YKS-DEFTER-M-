...
const [bundle,app,sw,versionText,recovery,stability,personal,progress,labV2,labV3,studyCss,polishCss,homePolishCss]=await Promise.all([
...
if(!sw.includes('const APP_VERSION="4.1.0"')||!sw.includes('const APP_BUILD="4.1.0-r20"')||!sw.includes('const CACHE="yks-core-v4.1.0-r33"'))throw new Error("Kopyalanan service worker kararlı sürüm/cache revizyonuyla eşleşmiyor");
