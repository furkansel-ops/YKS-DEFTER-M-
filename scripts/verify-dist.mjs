...
if(!sw.includes('motivation-quotes-v1.js?v=4.1.0-r3')||!sw.includes('motivation-quotes-v2.css?v=4.1.0-r2')||!stability.includes('motivation-quotes-v1.js?v=4.1.0-r3'))throw new Error("Günün sözü çalışma zamanı/PWA çekirdeğine bağlı değil");
if(!motivation.includes('const EXAM_QUOTES=')||!motivation.includes('const COACH_QUOTES=')||!motivation.includes('const PLAYER_QUOTES=')||!motivation.includes('scope:"YKS+football"')||!motivation.includes('style:"v2"')||!motivation.includes('Teknik Direktör')||!motivation.includes('Futbolcu')||!motivation.includes('yeniSoz=function'))throw new Error("YKS + futbol söz havuzu eksik veya paketlenmedi");
