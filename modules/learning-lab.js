(function(){
  ...
  function render(){renderSummary();renderParagraphStats();renderParagraphHistory();if(tab==="periodic")renderElements();if(tab==="timeline")renderTimeline();return true;}
  ...
  window.YKSLearningLab={elements:ELEMENTS,timeline:TIMELINE,wordCount};
})();
