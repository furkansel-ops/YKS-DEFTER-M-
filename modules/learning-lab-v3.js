/* YKS Defterim — Öğrenme Laboratuvarı v3 | ana araç sadeleştirme + periyodik tablo çalışma katmanı */
(function(){
  "use strict";
  ...
  function injectStyle(){
    ...
    const s=document.createElement("style");s.id="v4LearningLabV3Style";s.textContent=`
      ...
      @media(max-width:760px){#v320LearningLab .v4lab-main-tabs,.v4-science-grid,.v4-yks-trend-panel,.v4-element-yks-grid{grid-template-columns:1fr}.v4-science-head{flex-direction:column}.v4-periodic-trends{grid-template-columns:repeat(2,minmax(0,1fr))}.v4-periodic-filter-meta{width:100%;margin-left:0}}
  ...
  function ensureStructure(){
    ...
    wrapPeriodicReset();window.v320SetTab=setTab;if(active==="periodic")ensurePeriodicStudy();else if(active==="science")renderScience();return true;
  }
  ...
  window.YKSLearningLabV3={version:"3.1.0",setTab,renderScience,ensureStructure,applyPeriodicFilters,enhancePeriodicDetail,yksFocus:YKS_FOCUS};
})();
