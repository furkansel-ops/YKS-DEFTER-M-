...
(function(){
  ...
  window.addEventListener("yks:v4-bootstrap",()=>{if(active==="science")renderScience();if(active==="atlas")window.YKSBiologyAtlas?.mount?.($("v320PanelAtlas"));});
  if(document.readyState==="loading")document.addEventListener("DOMContentLoaded",start,{once:true});else start();
  window.YKSLearningLabV3={version:"3.4.0",setTab,renderScience,ensureStructure,applyPeriodicFilters,enhancePeriodicDetail,ensureTimelineExperience,decorateTimeline,yksFocus:YKS_FOCUS};
})();
