...
function runBuiltInSelfTest(){
  ...
  const versionOk=typeof APP_VERSION==="string"&&APP_VERSION==="3.2.7"&&APP_CHANNEL==="Kararlı"&&DATA_SCHEMA===21;
...
function runV26SelfTest(){
  ...
  try{
    ...
    add("version",APP_VERSION==="3.2.7"&&V26_VERSION==="2.6.0"&&DATA_SCHEMA===21);add("study-no-double",st&&st.total===40);add("wrong",wr&&wr.total===5&&wr.examMarked===5);add("review",!!c.due[fkey]);add("risk",ri.score>=30);add("html",!!el("v26TopicOverview")&&!!el("v26TopicAttention")&&!!el("v26TopicModal")&&!!el("tfRisk"));
...
function runV251SelfTest(){
  ...
  try{
    ...
    add("version",APP_VERSION==="3.2.7"&&V251_VERSION==="2.5.1"&&DATA_SCHEMA===21);
...
function runV31SelfTest(){
  ...
  try{
    add("version",APP_VERSION==="3.2.7"&&V31_VERSION==="3.1.3"&&DATA_SCHEMA===21);
...
(function(){
  ...
  function runV314SelfTest(){
    ...
    try{
      const a=repair();add('version',APP_VERSION==='3.2.7'&&LAYOUT_VERSION==='3.1.4');add('layout-health',a.ok);
...
function runV319SelfTest(){
  ...
  try{
    add("version",APP_VERSION==="3.2.7"&&V319_VERSION==="3.2.7"&&DATA_SCHEMA===21);
