...
/* Yatay swipe ile ekran değiştirme v3.2.4 itibarıyla kaldırıldı. */
function initKeys(){
...
/* v3.2.4 — 1000 kişi sözü; ek havuz public-domain quote corpusundan seçildi. */
...
function runBuiltInSelfTest(){
  ...
  const versionOk=typeof APP_VERSION==="string"&&APP_VERSION==="3.2.4"&&APP_CHANNEL==="Kararlı"&&DATA_SCHEMA===21;
...
function runV26SelfTest(){
  ...
  try{
    ...
    add("version",APP_VERSION==="3.2.4"&&V26_VERSION==="2.6.0"&&DATA_SCHEMA===21);add("study-no-double",st&&st.total===40);add("wrong",wr&&wr.total===5&&wr.examMarked===5);add("review",!!c.due[fkey]);add("risk",ri.score>=30);add("html",!!el("v26TopicOverview")&&!!el("v26TopicAttention")&&!!el("v26TopicModal")&&!!el("tfRisk"));
...
function runV251SelfTest(){
  ...
  try{
    ...
    add("version",APP_VERSION==="3.2.4"&&V251_VERSION==="2.5.1"&&DATA_SCHEMA===21);
...
function runV31SelfTest(){
  ...
  try{
    add("version",APP_VERSION==="3.2.4"&&V31_VERSION==="3.1.3"&&DATA_SCHEMA===21);
...
(function(){
  ...
  function buildDeneme(){
    ...
    /* v3.2.4 Deneme Analiz Merkezi kendi tam-genişlik düzenini yönetir. */
  ...
  function runV314SelfTest(){
    ...
    try{
      const a=repair();add('version',APP_VERSION==='3.2.4'&&LAYOUT_VERSION==='3.1.4');add('layout-health',a.ok);
...
/* ---- legacy-block-7 ---- */
/* ==================================================================
   YKS Defterim v3.2.4 — Deneme Analiz Merkezi
...
/* Genel self-test zincirine v3.2.4'i ekle. */
...
/* ---- legacy-block-8 ---- */
/* ==================================================================
   YKS Defterim v3.2.4 — Odak Bahçesi
...
/* ---- legacy-block-10 ---- */
/* ==================================================================
   YKS Defterim v3.2.4 — Büyük Günün Sözü + Başarı & Ödül Merkezi
   Tüm ödüller mevcut kayıtların salt-okuma türevleridir; uygulama şeması 20'dir.
   ================================================================== */
const V319_VERSION="3.2.4";
...
function runV319SelfTest(){
  ...
  try{
    add("version",APP_VERSION==="3.2.4"&&V319_VERSION==="3.2.4"&&DATA_SCHEMA===21);
