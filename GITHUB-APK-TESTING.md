...
Güncel test adayı **YKS Defterim 4.4.0-r4**, Android `versionCode` **4040004** ve dosya adı **`YKS-Defterim-4.4.0-4040004.apk`** olarak hazırlanır. Yalnız bu build'in doğrulanmış Release dosyası kurulmalıdır.
...
- Her yeni sürümde `versionCode` artırılır. Örneğin bir sonraki `4.4.0-r5` için `4040005` kullanılır.
