...
test('Öğrenme Laboratuvarı v3 paragraf aracını kaldırır, YKS periyodik katmanını ve kronoloji timeline yapısını kurar',()=>{
  ...
  assert.match(sw,/study-intelligence-core\.js\?v=4\.1\.0-r1/);
  assert.match(sw,/study-intelligence-v5\.js\?v=4\.1\.0-r1/);
  assert.match(sw,/repeat-center-v42\.js\?v=4\.2\.0-r1/);
  assert.match(sw,/repeat-center-v42\.css\?v=4\.2\.0-r1/);
  ...
  assert.match(sw,/yks-core-v4\.1\.0-r38/);
  assert.match(sw,/yks-core-v4\.1\.0-r37/);
  assert.match(sw,/yks-core-v4\.1\.0-r36/);
