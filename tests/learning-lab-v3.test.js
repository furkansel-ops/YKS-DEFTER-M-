...
test('Öğrenme Laboratuvarı v3 paragraf aracını kaldırır, YKS periyodik katmanını ve kronoloji timeline yapısını kurar',()=>{
  ...
  assert.match(sw,/learning-lab-v2\.js/);
  assert.match(sw,/learning-lab-v3\.js/);
  assert.match(sw,/motivation-quotes-v1\.js/);
  assert.match(sw,/motivation-quotes-v2\.css/);
  assert.match(sw,/ui-polish-progress-v2\.css/);
  assert.match(sw,/ui-polish-program-v1\.css/);
  assert.match(sw,/ui-polish-learning-lab-v1\.css/);
