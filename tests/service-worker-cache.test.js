...
const cacheName="yks-core-v4.4.0-r2";
...
const previous={"./":oldHtml,"./index.html":oldHtml,"./assets/index-old.js":"old bundle","./app.js?v=4.1.0-r20":"old app","./__offline_ready__":"4.4.0-r2"};
...
test("successful install stores exact checked shell after assets and activates last",async()=>{
  ...
  assert.equal(await runtime.body("./__offline_ready__"),"4.4.0-r2");
