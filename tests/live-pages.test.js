...
test("canlı Pages denetimi Vite ve eski çalışma zamanı paketini doğrular",async()=>{
  ...
  const index='<script type="module" src="./assets/index-AbC123.js"></script><script src="./app.js?v=4.0.0-r14"></script><script src="./modules/release-selftest.js?v=4.0.0-r14"></script>';
...
test("canlı Pages denetimi kaynak TypeScript veya bozuk UTF-8 paketini reddeder",async()=>{
  ...
  const legacy='<script src="./app.js?v=4.0.0-r14"></script><script src="./modules/release-selftest.js?v=4.0.0-r14"></script>';
