...
test("canlı Pages denetimi gerçek release sürümünü, güvenli runtime'ı ve eski çalışma zamanı paketini doğrular",async()=>{
  ...
  const index='<script type="module" src="./assets/index-AbC123.js"></script><script src="./app.js?v=4.4.0-r3"></script><script src="./modules/core-utils.js?v=4.4.0-r3"></script><script src="./modules/release-selftest.js?v=4.1.0-r20"></script>';
...
test("canlı Pages denetimi yanlış release, kaynak TypeScript, bozuk UTF-8 veya yanlış PWA cache'ini reddeder",async()=>{
  ...
  const legacy='<script src="./app.js?v=4.4.0-r3"></script><script src="./modules/core-utils.js?v=4.4.0-r3"></script><script src="./modules/release-selftest.js?v=4.1.0-r20"></script>',app='const APP_VERSION="4.1.0";const APP_BUILD="4.1.0-r20"',index=`<script type="module" src="./assets/index-x.js"></script>${legacy}`;
