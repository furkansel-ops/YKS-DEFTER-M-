...
const goodBundle="YKS_V4_RELEASE_OK 4.4.0 4.4.0-r4 stable v43Runtime v43RuntimeErrors degraded v43FocusSessionGuard";
...
test("canlı Pages denetimi yanlış release, kaynak TypeScript, bozuk UTF-8 veya yanlış PWA cache'ini reddeder",async()=>{
  ...
  assert.throws(()=>verifyLiveAssets({index,bundle:goodBundle.replace("4.4.0-r4","4.4.0-r3"),legacyApp:app,serviceWorker:goodSw}),/4\.4\.0-r4/);
