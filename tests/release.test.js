...
function harness(){
  ...
  const host={
    __YKS_V4_BOOTSTRAP__:{version:"4.4.0",build:"4.4.0-r4",legacyCore:"4.1.0-r20",channel:"stable",legacyRuntime:true},
    __YKS_SERVICES__:{validate:()=>[]},__YKS_DOMAIN__:{validate:()=>[]},__YKS_SCREEN_RUNTIME__:{validate:()=>[]},__YKS_UI__:ui,__YKS_DATA__:data,
    __YKS_BACKUP__:{version:"2.0.0"},__YKS_PWA__:{build:"4.4.0-r4"},__YKS_V43_RUNTIME__:{ready:Promise.resolve({ok:true})},
