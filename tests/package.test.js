...
test("sürüm, şema ve PWA önbelleği tutarlı",()=>{
  ...
  assert.match(html,/src="\.\/app\.js\?v=4\.1\.0-r20"/);assert.match(html,/src="\.\/modules\/stability\.js\?v=4\.1\.0-r27"/);assert.match(app,/const APP_VERSION="4\.1\.0"/);assert.match(app,/const APP_BUILD="4\.1\.0-r20"/);assert.match(app,/const DATA_SCHEMA=21/);
