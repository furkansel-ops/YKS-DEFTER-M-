...
test("v4.3 ürün modülleri ana bootstrap içinde statik kurulmaz",()=>{
  ...
  for(const file of ["today-v43","program-v5","program-builder-v5","analysis-center-v43","learning-cycle-v43","lab-quiz-v43","navigation-v43","personalization-v43","focus-session-guard-v43","focus-v5","progress-v5"]){
