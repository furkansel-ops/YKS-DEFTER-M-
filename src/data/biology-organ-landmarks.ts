...
export const ORGAN_LANDMARKS:Readonly<Record<OrganId,Readonly<Record<string,OrganLandmark>>>>={
  ...
  ear:{"ear-canal":surface([-.67,-.10,.47]),eardrum:inside([.31,-.055,.49]),ossicles:inside([.59,.16,.53]),"eustachian-tube":inside([.81,-.76,.46]),vestibule:inside([.90,.12,.50]),"semicircular-canals":inside([1.01,.70,.52]),cochlea:inside([1.20,-.18,.51]),"auditory-nerve":inside([1.68,.01,.47])},
