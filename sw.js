...
const APP_BUILD="4.4.0-r1";
const CACHE="yks-core-v4.4.0-r1";
const CACHE_LINEAGE=["yks-core-v4.1.0-r20","yks-core-v4.1.0-r21","yks-core-v4.1.0-r22","yks-core-v4.1.0-r23","yks-core-v4.1.0-r24","yks-core-v4.1.0-r25","yks-core-v4.1.0-r26","yks-core-v4.1.0-r27","yks-core-v4.1.0-r28","yks-core-v4.1.0-r29","yks-core-v4.1.0-r30","yks-core-v4.1.0-r31","yks-core-v4.1.0-r32","yks-core-v4.1.0-r33","yks-core-v4.1.0-r34","yks-core-v4.1.0-r35","yks-core-v4.1.0-r36","yks-core-v4.1.0-r37","yks-core-v4.1.0-r38","yks-core-v4.1.0-r39","yks-core-v4.1.0-r40","yks-core-v4.2.0-r1","yks-core-v4.3.0-r1","yks-core-v4.3.1-r1"];
const READY_KEY="./__offline_ready__";
const CORE=["./","./index.html","./app.css","./app.js?v=4.1.0-r20","./teacher-videos.js","./modules/core-utils.js?v=4.1.0-r27","./modules/stability.js?v=4.1.0-r28","./modules/topic-guides.js?v=4.1.0-r20","./modules/learning-lab.js?v=4.1.0-r26","./modules/learning-lab-v2.js?v=4.1.0-r24","./modules/learning-lab-v3.js?v=4.1.0-r28","./modules/target-center.js?v=4.1.0-r20","./modules/export-center.js?v=4.1.0-r20","./modules/error-journal.js","./modules/personal-upgrades.js","./modules/progress-v2.js","./modules/global-search-v42.js","./modules/smart-repeat-v42.js","./modules/error-topic-lab-v42.js","./modules/exam-analysis-v42.js","./modules/progress-v42.js?v=4.2.0-r1","./modules/learning-lab-flow-v42.js?v=4.2.0-r1","./modules/release-selftest.js?v=4.1.0-r20","./modules/motivation-quotes-v1.js?v=4.1.0-r2","./modules/motivation-quotes-v2.css?v=4.1.0-r1","./modules/study-intelligence-v5.css","./modules/ui-polish-v1.css","./modules/ui-polish-home-v2.css","./modules/ui-polish-focus-v1.css","./modules/ui-polish-exam-v1.css","./modules/ui-polish-topics-v1.css","./modules/ui-polish-error-journal-v1.css","./modules/ui-polish-progress-v1.css","./modules/ui-polish-progress-v2.css?v=4.1.0-r1","./modules/ui-polish-more-v1.css","./modules/ui-polish-program-v1.css?v=4.1.0-r1","./modules/ui-polish-learning-lab-v1.css?v=4.1.0-r1","./modules/ui-polish-final-v1.css?v=4.1.0-r1","./manifest.webmanifest","./icon-192.png","./icon-512.png","./icon-maskable-512.png","./apple-touch-icon.png"];
...
self.addEventListener("install",event=>{
  /* Yeni worker ancak temel uygulama kabuğu gerçekten hazırsa kurulmuş sayılır.
     Aynı release build içinde yapılan bakım güncellemeleri de no-store ile mevcut cache
     anahtarını tazeleyerek eski app.js + yeni Vite paketinin karışmasını engeller. */
