...
const CACHE="yks-core-v4.0.0-r14";
const CORE=["./","./index.html","./app.css","./app.js?v=4.0.0-r14","./modules/core-utils.js?v=4.0.0-r14","./modules/stability.js?v=4.0.0-r14","./modules/topic-guides.js?v=4.0.0-r14","./modules/learning-lab.js?v=4.0.0-r14","./modules/target-center.js?v=4.0.0-r14","./modules/export-center.js?v=4.0.0-r14","./modules/release-selftest.js?v=4.0.0-r14","./manifest.webmanifest","./icon-192.png","./icon-512.png","./icon-maskable-512.png","./apple-touch-icon.png"];
