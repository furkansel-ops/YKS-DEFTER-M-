...
const CACHE="yks-core-v4.0.0-r17";
const CORE=["./","./index.html","./app.css","./app.js?v=4.0.0-r17","./modules/core-utils.js?v=4.0.0-r17","./modules/stability.js?v=4.0.0-r17","./modules/topic-guides.js?v=4.0.0-r17","./modules/learning-lab.js?v=4.0.0-r17","./modules/target-center.js?v=4.0.0-r17","./modules/export-center.js?v=4.0.0-r17","./modules/release-selftest.js?v=4.0.0-r17","./manifest.webmanifest","./icon-192.png","./icon-512.png","./icon-maskable-512.png","./apple-touch-icon.png"];
